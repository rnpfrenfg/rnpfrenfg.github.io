...
export { Box, BoxParser, BoxRegistry, DIFF_BOXES_PROP_NAMES, DIFF_PRIMITIVE_ARRAY_PROP_NAMES, Sample, TX3GParser, Textin4Parser, TypedArray, VTTin4Parser, XMLSubtitlein4Parser, boxEqual, boxEqualFields };
