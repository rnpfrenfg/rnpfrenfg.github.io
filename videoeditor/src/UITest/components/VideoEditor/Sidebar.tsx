        ...
        <div className="flex">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex-1 p-3 flex flex-col items-center space-y-1 transition-colors cursor-pointer \${
                activeTab === tab.id 
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {activeTab === 'audio' && (
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {['Upbeat Corporate', 'Cinematic Drama', 'Acoustic Guitar', 'Electronic Beats'].map((track, i) => (
        ...
        {activeTab === 'text' && (
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {['제목 템플릿', '자막 스타일', '로고 텍스트', '엔딩 크레딧'].map((template, i) => (
                <div key={i} className="p-3 bg-gray-800 rounded-lg hover:bg-gray-700 cursor-pointer transition-colors">
