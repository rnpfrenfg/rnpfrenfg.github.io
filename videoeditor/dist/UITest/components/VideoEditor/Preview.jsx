...
export default function Preview() {
    ...
    return (<div className="bg-black flex-1 flex items-center justify-center relative">
      <div className="relative w-full max-w-4xl aspect-video bg-gray-900 rounded-lg overflow-hidden">
        <img src="https://readdy.ai/api/search-image?query=modern%20video%20editing%20workspace%20with%20multiple%20monitors%20displaying%20colorful%20video%20clips%20and%20professional%20lighting%20setup%20in%20a%20creative%20studio%20environment&width=800&height=450&seq=preview1&orientation=landscape" alt="비디오 프리뷰" className="w-full h-full object-cover object-top"/>
        
        {!isPlaying && (<div className="absolute inset-0 flex items-center justify-center bg-black/30">
            <button onClick={() => setIsPlaying(!isPlaying)} className="w-20 h-20 flex items-center justify-center bg-white/20 backdrop-blur-sm rounded-full hover:bg-white/30 transition-colors cursor-pointer">
