...
var DataStream = (_a = class _DataStream {
        /**
        ...
        constructor(arrayBuffer, byteOffset, endianness) {
            __DataStream_instances.add(this);
            /**
        ...
        readInt32(endianness) {
            const v = this._dataView.getInt32(this.position, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 4;
            return v;
        }
        /**
        ...
        readInt16(endianness) {
            const v = this._dataView.getInt16(this.position, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 2;
            return v;
        }
        /**
        ...
        readUint32(endianness) {
            const v = this._dataView.getUint32(this.position, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 4;
            return v;
        }
        /**
        ...
        readUint16(endianness) {
            const v = this._dataView.getUint16(this.position, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 2;
            return v;
        }
        /**
        ...
        readFloat32(endianness) {
            const value = this._dataView.getFloat32(this.position, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 4;
            return value;
        }
        /**
        ...
        readFloat64(endianness) {
            const value = this._dataView.getFloat64(this.position, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 8;
            return value;
        }
        /**
        ...
        static nativeToEndian(typedArray, littleEndian) {
            if (littleEndian && _a.ENDIANNESS === 2 /* LITTLE_ENDIAN */) {
                return typedArray;
            }
            else {
                return this.flipArrayEndianness(typedArray);
        ...
        readString(length, encoding) {
            if (encoding === void 0 || encoding === "ASCII") {
                return fromCharCodeUint8(this.mapUint8Array(length === void 0 ? this.byteLength - this.position : length));
            }
            else {
        ...
        writeInt64(value, endianness) {
            this._realloc(8);
            this._dataView.setBigInt64(this.position, BigInt(value), (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 8;
        }
        /**
        ...
        writeInt32(value, endianness) {
            this._realloc(4);
            this._dataView.setInt32(this.position, value, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 4;
        }
        /**
        ...
        writeInt16(value, endianness) {
            this._realloc(2);
            this._dataView.setInt16(this.position, value, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 2;
        }
        /**
        ...
        writeUint32(value, endianness) {
            this._realloc(4);
            this._dataView.setUint32(this.position, value, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 4;
        }
        /**
        ...
        writeUint16(value, endianness) {
            this._realloc(2);
            this._dataView.setUint16(this.position, value, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 2;
        }
        /**
        ...
        writeFloat32(value, endianness) {
            this._realloc(4);
            this._dataView.setFloat32(this.position, value, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 4;
        }
        /**
        ...
        writeFloat64(value, endianness) {
            this._realloc(8);
            this._dataView.setFloat64(this.position, value, (endianness ?? this.endianness) === 2 /* LITTLE_ENDIAN */);
            this.position += 8;
        }
        /**
        ...
        writeType(type, value, struct) {
            ...
            switch (parsedType) {
                ...
                case "u16stringbe":
                    ...
                    break;
                default:
                    if (__classPrivateFieldGet(this, __DataStream_instances, "m", __DataStream_isTupleType).call(this, parsedType)) {
                        const [, ta] = parsedType;
            ...
            switch (parsedType) {
                ...
                default:
                    if (__classPrivateFieldGet(this, __DataStream_instances, "m", __DataStream_isTupleType).call(this, parsedType)) {
                        ...
                        parseInt(struct[len])) : typeof len === "number" ? len : len === "*" ? void 0 : parseInt(len);
                        if (typeof ta === "string") {
    ...
    __DataStream_instances = new WeakSet(),
    __DataStream_isTupleType = function __DataStream_isTupleType(type) {
        return Array.isArray(type) && type.length === 3 && type[0] === "[]";
    },
    (() => {
        _a.ENDIANNESS = new Int8Array(new Int16Array([1]).buffer)[0] > 0 ? 2 /* LITTLE_ENDIAN */ : 1 /* BIG_ENDIAN */;
    })(),
    _a);
...
var Log = {
    ...
    debug(module, msg) {
        ...
        if (LOG_LEVEL_DEBUG >= log_level) {
            console.debug("[" + Log.getDurationString(( /* @__PURE__ */new Date()).getTime() - start.getTime(), 1e3) + "]", "[" + module + "]", msg);
        }
    },
    log(module, _msg) {
    ...
    info(module, msg) {
        if (LOG_LEVEL_INFO >= log_level) {
            console.info("[" + Log.getDurationString(( /* @__PURE__ */new Date()).getTime() - start.getTime(), 1e3) + "]", "[" + module + "]", msg);
        }
    },
    warn(module, msg) {
        if (LOG_LEVEL_WARNING >= log_level) {
            console.warn("[" + Log.getDurationString(( /* @__PURE__ */new Date()).getTime() - start.getTime(), 1e3) + "]", "[" + module + "]", msg);
        }
    },
    error(module, msg, isofile) {
        if (isofile?.onError) {
            ...
            console.error("[" + Log.getDurationString(( /* @__PURE__ */new Date()).getTime() - start.getTime(), 1e3) + "]", "[" + module + "]", msg);
        }
    },
...
var MultiBufferStream = class extends DataStream {
     ...
     */
    getPosition() {
        if (this.bufferIndex === -1 || this.buffers[this.bufferIndex] === void 0)
            return 0;
...
var Box = (_b = class {
        constructor(size = 0) {
            ...
            _Box_type.set(this, void 0);
            this.size = size;
        }
        get type() {
            return this.constructor.fourcc ?? __classPrivateFieldGet(this, _Box_type, "f");
        }
        set type(value) {
            __classPrivateFieldSet(this, _Box_type, value, "f");
        }
        addBox(box) {
            if (!this.boxes) {
                this.boxes = [];
    ...
    _Box_type = new WeakMap(),
    __setFunctionName(_b, "Box"),
    (() => {
        _b.registryId = Symbol.for("BoxIdentifier");
    })(),
    _b);
...
var SampleGroupEntry = (_c = class {
    ...
    __setFunctionName(_c, "SampleGroupEntry"),
    (() => {
        _c.registryId = Symbol.for("SampleGroupEntryIdentifier");
    })(),
    _c);
...
function registerBoxes(registry) {
    ...
    for (const [key, value] of Object.entries(registry)) {
        if (isSampleGroupEntry(value)) {
            ...
            if (!groupingType) {
                throw new Error(`SampleGroupEntry class ${key} does not have a valid static grouping_type. Please ensure it is defined correctly.`);
            }
            if (groupingType in localRegistry.sampleGroupEntry) {
                throw new Error(`SampleGroupEntry class ${key} has a grouping_type that is already registered. Please ensure it is unique.`);
            }
        ...
        if (isSampleEntry(value)) {
            ...
            if (!fourcc) {
                throw new Error(`SampleEntry class ${key} does not have a valid static fourcc. Please ensure it is defined correctly.`);
            }
            if (fourcc in localRegistry.sampleEntry) {
                throw new Error(`SampleEntry class ${key} has a fourcc that is already registered. Please ensure it is unique.`);
            }
        ...
        if (isBox(value)) {
            ...
            if (fourcc === "uuid") {
                if (!uuid) {
                    throw new Error(`Box class ${key} has a fourcc of 'uuid' but does not have a valid uuid. Please ensure it is defined correctly.`);
                }
                if (uuid in localRegistry.uuid) {
                    throw new Error(`Box class ${key} has a uuid that is already registered. Please ensure it is unique.`);
                }
        ...
        while (stream.getPosition() < this.start + this.size) {
            ...
            if (ret.code === OK) {
                ...
                if (this.subBoxNames && this.subBoxNames.indexOf(box.type) !== -1) {
                    ...
                    if (this[box_type]) {
                        Log.warn("ContainerBox", `Box of type ${box_type} already exists in container box ${this.type}.`);
                    }
                    else {
                        this[box_type] = box;
                    }
...
var SampleEntry = (_d = class extends ContainerBox {
    ...
    __setFunctionName(_d, "SampleEntry"),
    (() => {
        _d.registryId = Symbol.for("SampleEntryIdentifier");
    })(),
    _d);
...
var freeBox = (_h = class extends Box {
    ...
    __setFunctionName(_h, "freeBox"),
    (() => {
        _h.fourcc = "free";
    })(),
    _h);
var skipBox = (_j = class extends Box {
        constructor() {
            super(...arguments);
            this.box_name = "FreeSpaceBox";
        }
    },
    __setFunctionName(_j, "skipBox"),
    (() => {
        _j.fourcc = "skip";
    })(),
    _j);
var hmhdBox = (_k = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "HintMediaHeaderBox";
        }
    },
    __setFunctionName(_k, "hmhdBox"),
    (() => {
        _k.fourcc = "hmhd";
    })(),
    _k);
var nmhdBox = (_l = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "NullMediaHeaderBox";
        }
    },
    __setFunctionName(_l, "nmhdBox"),
    (() => {
        _l.fourcc = "nmhd";
    })(),
    _l);
var iodsBox = (_m = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "ObjectDescriptorBox";
        }
    },
    __setFunctionName(_m, "iodsBox"),
    (() => {
        _m.fourcc = "iods";
    })(),
    _m);
var xmlBox = (_o = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "XMLBox";
        }
    },
    __setFunctionName(_o, "xmlBox"),
    (() => {
        _o.fourcc = "xml ";
    })(),
    _o);
var bxmlBox = (_p = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "BinaryXMLBox";
        }
    },
    __setFunctionName(_p, "bxmlBox"),
    (() => {
        _p.fourcc = "bxml";
    })(),
    _p);
var iproBox = (_q = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_q, "iproBox"),
    (() => {
        _q.fourcc = "ipro";
    })(),
    _q);
var moovBox = (_r = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_r, "moovBox"),
    (() => {
        _r.fourcc = "moov";
    })(),
    _r);
var trakBox = (_s = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_s, "trakBox"),
    (() => {
        _s.fourcc = "trak";
    })(),
    _s);
var edtsBox = (_t = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "EditBox";
        }
    },
    __setFunctionName(_t, "edtsBox"),
    (() => {
        _t.fourcc = "edts";
    })(),
    _t);
var mdiaBox = (_u = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "MediaBox";
        }
    },
    __setFunctionName(_u, "mdiaBox"),
    (() => {
        _u.fourcc = "mdia";
    })(),
    _u);
var minfBox = (_v = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "MediaInformationBox";
        }
    },
    __setFunctionName(_v, "minfBox"),
    (() => {
        _v.fourcc = "minf";
    })(),
    _v);
var dinfBox = (_w = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "DataInformationBox";
        }
    },
    __setFunctionName(_w, "dinfBox"),
    (() => {
        _w.fourcc = "dinf";
    })(),
    _w);
var stblBox = (_x = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_x, "stblBox"),
    (() => {
        _x.fourcc = "stbl";
    })(),
    _x);
var mvexBox = (_y = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_y, "mvexBox"),
    (() => {
        _y.fourcc = "mvex";
    })(),
    _y);
var moofBox = (_z = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_z, "moofBox"),
    (() => {
        _z.fourcc = "moof";
    })(),
    _z);
var trafBox = (_0 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_0, "trafBox"),
    (() => {
        _0.fourcc = "traf";
    })(),
    _0);
var vttcBox = (_1 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "VTTCueBox";
        }
    },
    __setFunctionName(_1, "vttcBox"),
    (() => {
        _1.fourcc = "vttc";
    })(),
    _1);
var mfraBox = (_2 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_2, "mfraBox"),
    (() => {
        _2.fourcc = "mfra";
    })(),
    _2);
var mecoBox = (_3 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "AdditionalMetadataContainerBox";
        }
    },
    __setFunctionName(_3, "mecoBox"),
    (() => {
        _3.fourcc = "meco";
    })(),
    _3);
var hntiBox = (_4 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_4, "hntiBox"),
    (() => {
        _4.fourcc = "hnti";
    })(),
    _4);
var hinfBox = (_5 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_5, "hinfBox"),
    (() => {
        _5.fourcc = "hinf";
    })(),
    _5);
var strkBox = (_6 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "SubTrackBox";
        }
    },
    __setFunctionName(_6, "strkBox"),
    (() => {
        _6.fourcc = "strk";
    })(),
    _6);
var strdBox = (_7 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "SubTrackDefinitionBox";
        }
    },
    __setFunctionName(_7, "strdBox"),
    (() => {
        _7.fourcc = "strd";
    })(),
    _7);
var sinfBox = (_8 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "ProtectionSchemeInfoBox";
        }
    },
    __setFunctionName(_8, "sinfBox"),
    (() => {
        _8.fourcc = "sinf";
    })(),
    _8);
var rinfBox = (_9 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "RestrictedSchemeInfoBox";
        }
    },
    __setFunctionName(_9, "rinfBox"),
    (() => {
        _9.fourcc = "rinf";
    })(),
    _9);
var schiBox = (_10 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "SchemeInformationBox";
        }
    },
    __setFunctionName(_10, "schiBox"),
    (() => {
        _10.fourcc = "schi";
    })(),
    _10);
var trgrBox = (_11 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "TrackGroupBox";
        }
    },
    __setFunctionName(_11, "trgrBox"),
    (() => {
        _11.fourcc = "trgr";
    })(),
    _11);
var udtaBox = (_12 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_12, "udtaBox"),
    (() => {
        _12.fourcc = "udta";
    })(),
    _12);
var iprpBox = (_13 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_13, "iprpBox"),
    (() => {
        _13.fourcc = "iprp";
    })(),
    _13);
var ipcoBox = (_14 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_14, "ipcoBox"),
    (() => {
        _14.fourcc = "ipco";
    })(),
    _14);
var grplBox = (_15 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "GroupsListBox";
        }
    },
    __setFunctionName(_15, "grplBox"),
    (() => {
        _15.fourcc = "grpl";
    })(),
    _15);
var j2kHBox = (_16 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "J2KHeaderInfoBox";
        }
    },
    __setFunctionName(_16, "j2kHBox"),
    (() => {
        _16.fourcc = "j2kH";
    })(),
    _16);
var etypBox = (_17 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_17, "etypBox"),
    (() => {
        _17.fourcc = "etyp";
    })(),
    _17);
var povdBox = (_18 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_18, "povdBox"),
    (() => {
        _18.fourcc = "povd";
    })(),
    _18);
// src/boxes/dref.ts
var drefBox = (_19 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_19, "drefBox"),
    (() => {
        _19.fourcc = "dref";
    })(),
    _19);
// src/boxes/elng.ts
var elngBox = (_20 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_20, "elngBox"),
    (() => {
        _20.fourcc = "elng";
    })(),
    _20);
// src/boxes/ftyp.ts
var ftypBox = (_21 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_21, "ftypBox"),
    (() => {
        _21.fourcc = "ftyp";
    })(),
    _21);
// src/boxes/hdlr.ts
var hdlrBox = (_22 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_22, "hdlrBox"),
    (() => {
        _22.fourcc = "hdlr";
    })(),
    _22);
// src/boxes/hvcC.ts
var hvcCBox = (_23 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_23, "hvcCBox"),
    (() => {
        _23.fourcc = "hvcC";
    })(),
    _23);
// src/boxes/mdhd.ts
var mdhdBox = (_24 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_24, "mdhdBox"),
    (() => {
        _24.fourcc = "mdhd";
    })(),
    _24);
// src/boxes/mehd.ts
var mehdBox = (_25 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_25, "mehdBox"),
    (() => {
        _25.fourcc = "mehd";
    })(),
    _25);
// src/boxes/infe.ts
var infeBox = (_26 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_26, "infeBox"),
    (() => {
        _26.fourcc = "infe";
    })(),
    _26);
// src/boxes/iinf.ts
var iinfBox = (_27 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_27, "iinfBox"),
    (() => {
        _27.fourcc = "iinf";
    })(),
    _27);
// src/boxes/iloc.ts
var ilocBox = (_28 = class extends FullBox {
        constructor() {
            super(...arguments);
...
var irefBox = (_29 = class _irefBox extends FullBox {
        constructor() {
            super(...arguments);
        ...
        parse(stream) {
            ...
            while (stream.getPosition() < this.start + this.size) {
                ...
                if (ret.code === OK) {
                    ...
                    if (!_29.allowed_types.includes(ret.type)) {
                        Log.warn("BoxParser", `Unknown item reference type: '${ret.type}'`);
                    }
                    else
                        name = REFERENCE_TYPE_NAMES[ret.type];
    ...
    _29);
// src/boxes/pitm.ts
var pitmBox = (_30 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_30, "pitmBox"),
    (() => {
        _30.fourcc = "pitm";
    })(),
    _30);
// src/boxes/meta.ts
var metaBox = (_31 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_31, "metaBox"),
    (() => {
        _31.fourcc = "meta";
    })(),
    _31);
// src/boxes/mfhd.ts
var mfhdBox = (_32 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_32, "mfhdBox"),
    (() => {
        _32.fourcc = "mfhd";
    })(),
    _32);
// src/boxes/mvhd.ts
var mvhdBox = (_33 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_33, "mvhdBox"),
    (() => {
        _33.fourcc = "mvhd";
    })(),
    _33);
// src/boxes/sampleentries/mett.ts
var mettSampleEntry = (_34 = class extends MetadataSampleEntry {
        parse(stream) {
            this.parseHeader(stream);
            this.content_encoding = stream.readCString();
    ...
    __setFunctionName(_34, "mettSampleEntry"),
    (() => {
        _34.fourcc = "mett";
    })(),
    _34);
// src/boxes/sampleentries/metx.ts
var metxSampleEntry = (_35 = class extends MetadataSampleEntry {
        parse(stream) {
            this.parseHeader(stream);
            this.content_encoding = stream.readCString();
    ...
    __setFunctionName(_35, "metxSampleEntry"),
    (() => {
        _35.fourcc = "metx";
    })(),
    _35);
// src/boxes/av1C.ts
var av1CBox = (_36 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_36, "av1CBox"),
    (() => {
        _36.fourcc = "av1C";
    })(),
    _36);
// src/boxes/esds.ts
var esdsBox = (_37 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_37, "esdsBox"),
    (() => {
        _37.fourcc = "esds";
    })(),
    _37);
// src/boxes/vpcC.ts
var vpcCBox = (_38 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_38, "vpcCBox"),
    (() => {
        _38.fourcc = "vpcC";
    })(),
    _38);
// src/boxes/vvcC.ts
var vvcCBox = (_39 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_39, "vvcCBox"),
    (() => {
        _39.fourcc = "vvcC";
    })(),
    _39);
// src/boxes/colr.ts
var colrBox = (_40 = class extends Box {
        constructor() {
            super(...arguments);
...
var avcCSampleEntryBase = class extends VisualSampleEntry {
    ...
    getCodec() {
        ...
        if (this.avcC) {
            return `${baseCodec}.${decimalToHex(this.avcC.AVCProfileIndication)}${decimalToHex(this.avcC.profile_compatibility)}${decimalToHex(this.avcC.AVCLevelIndication)}`;
        }
        else {
            return baseCodec;
        }
...
var avc1SampleEntry = (_41 = class extends avcCSampleEntryBase {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_41, "avc1SampleEntry"),
    (() => {
        _41.fourcc = "avc1";
    })(),
    _41);
var avc2SampleEntry = (_42 = class extends avcCSampleEntryBase {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-15:2024 5.4.2.1.2
    ...
    __setFunctionName(_42, "avc2SampleEntry"),
    (() => {
        _42.fourcc = "avc2";
    })(),
    _42);
var avc3SampleEntry = (_43 = class extends avcCSampleEntryBase {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-15:2024 5.4.2.1.2
            this.box_name = "AVCSampleEntry";
    ...
    __setFunctionName(_43, "avc3SampleEntry"),
    (() => {
        _43.fourcc = "avc3";
    })(),
    _43);
var avc4SampleEntry = (_44 = class extends avcCSampleEntryBase {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-15:2024 5.4.2.1.2
            this.box_name = "AVC2SampleEntry";
    ...
    __setFunctionName(_44, "avc4SampleEntry"),
    (() => {
        _44.fourcc = "avc4";
    })(),
    _44);
var av01SampleEntry = (_45 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_45, "av01SampleEntry"),
    (() => {
        _45.fourcc = "av01";
    })(),
    _45);
var dav1SampleEntry = (_46 = class extends VisualSampleEntry {
    },
    __setFunctionName(_46, "dav1SampleEntry"),
    (() => {
        _46.fourcc = "dav1";
    })(),
    _46);
...
var hvc1SampleEntry = (_47 = class extends hvcCSampleEntryBase {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_47, "hvc1SampleEntry"),
    (() => {
        _47.fourcc = "hvc1";
    })(),
    _47);
var hvc2SampleEntry = (_48 = class extends hvcCSampleEntryBase {
    },
    __setFunctionName(_48, "hvc2SampleEntry"),
    (() => {
        _48.fourcc = "hvc2";
    })(),
    _48);
var hev1SampleEntry = (_49 = class extends hvcCSampleEntryBase {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-15:2024 8.4.1.1.2
            this.box_name = "HEVCSampleEntry";
    ...
    __setFunctionName(_49, "hev1SampleEntry"),
    (() => {
        _49.fourcc = "hev1";
    })(),
    _49);
var hev2SampleEntry = (_50 = class extends hvcCSampleEntryBase {
    },
    __setFunctionName(_50, "hev2SampleEntry"),
    (() => {
        _50.fourcc = "hev2";
    })(),
    _50);
var hvt1SampleEntry = (_51 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_51, "hvt1SampleEntry"),
    (() => {
        _51.fourcc = "hvt1";
    })(),
    _51);
var lhe1SampleEntry = (_52 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_52, "lhe1SampleEntry"),
    (() => {
        _52.fourcc = "lhe1";
    })(),
    _52);
var lhv1SampleEntry = (_53 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-15:2024 9.5.3.1.2
            this.box_name = "LHEVCSampleEntry";
    ...
    __setFunctionName(_53, "lhv1SampleEntry"),
    (() => {
        _53.fourcc = "lhv1";
    })(),
    _53);
var dvh1SampleEntry = (_54 = class extends VisualSampleEntry {
    },
    __setFunctionName(_54, "dvh1SampleEntry"),
    (() => {
        _54.fourcc = "dvh1";
    })(),
    _54);
var dvheSampleEntry = (_55 = class extends VisualSampleEntry {
    },
    __setFunctionName(_55, "dvheSampleEntry"),
    (() => {
        _55.fourcc = "dvhe";
    })(),
    _55);
...
var vvc1SampleEntry = (_56 = class extends vvcCSampleEntryBase {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_56, "vvc1SampleEntry"),
    (() => {
        _56.fourcc = "vvc1";
    })(),
    _56);
var vvi1SampleEntry = (_57 = class extends vvcCSampleEntryBase {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-15:2024 11.3.1.2
            this.box_name = "VvcSampleEntry";
    ...
    __setFunctionName(_57, "vvi1SampleEntry"),
    (() => {
        _57.fourcc = "vvi1";
    })(),
    _57);
var vvs1SampleEntry = (_58 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-15:2024 11.3.1.2
            this.box_name = "VvcSampleEntry";
    ...
    __setFunctionName(_58, "vvs1SampleEntry"),
    (() => {
        _58.fourcc = "vvs1";
    })(),
    _58);
var vvcNSampleEntry = (_59 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_59, "vvcNSampleEntry"),
    (() => {
        _59.fourcc = "vvcN";
    })(),
    _59);
...
var vp08SampleEntry = (_60 = class extends vpcCSampleEntryBase {
    },
    __setFunctionName(_60, "vp08SampleEntry"),
    (() => {
        _60.fourcc = "vp08";
    })(),
    _60);
var vp09SampleEntry = (_61 = class extends vpcCSampleEntryBase {
    },
    __setFunctionName(_61, "vp09SampleEntry"),
    (() => {
        _61.fourcc = "vp09";
    })(),
    _61);
var avs3SampleEntry = (_62 = class extends VisualSampleEntry {
    },
    __setFunctionName(_62, "avs3SampleEntry"),
    (() => {
        _62.fourcc = "avs3";
    })(),
    _62);
var j2kiSampleEntry = (_63 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_63, "j2kiSampleEntry"),
    (() => {
        _63.fourcc = "j2ki";
    })(),
    _63);
var mjp2SampleEntry = (_64 = class extends VisualSampleEntry {
    },
    __setFunctionName(_64, "mjp2SampleEntry"),
    (() => {
        _64.fourcc = "mjp2";
    })(),
    _64);
var mjpgSampleEntry = (_65 = class extends VisualSampleEntry {
    },
    __setFunctionName(_65, "mjpgSampleEntry"),
    (() => {
        _65.fourcc = "mjpg";
    })(),
    _65);
var uncvSampleEntry = (_66 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_66, "uncvSampleEntry"),
    (() => {
        _66.fourcc = "uncv";
    })(),
    _66);
var mp4vSampleEntry = (_67 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_67, "mp4vSampleEntry"),
    (() => {
        _67.fourcc = "mp4v";
    })(),
    _67);
var mp4aSampleEntry = (_68 = class extends AudioSampleEntry {
        constructor() {
            super(...arguments);
            // ISO/IEC 14496-14:2020 Section 6.7.3
    ...
    __setFunctionName(_68, "mp4aSampleEntry"),
    (() => {
        _68.fourcc = "mp4a";
    })(),
    _68);
var m4aeSampleEntry = (_69 = class extends AudioSampleEntry {
    },
    __setFunctionName(_69, "m4aeSampleEntry"),
    (() => {
        _69.fourcc = "m4ae";
    })(),
    _69);
var ac_3SampleEntry = (_70 = class extends AudioSampleEntry {
    },
    __setFunctionName(_70, "ac_3SampleEntry"),
    (() => {
        _70.fourcc = "ac-3";
    })(),
    _70);
var ac_4SampleEntry = (_71 = class extends AudioSampleEntry {
    },
    __setFunctionName(_71, "ac_4SampleEntry"),
    (() => {
        _71.fourcc = "ac-4";
    })(),
    _71);
var ec_3SampleEntry = (_72 = class extends AudioSampleEntry {
    },
    __setFunctionName(_72, "ec_3SampleEntry"),
    (() => {
        _72.fourcc = "ec-3";
    })(),
    _72);
var OpusSampleEntry = (_73 = class extends AudioSampleEntry {
    },
    __setFunctionName(_73, "OpusSampleEntry"),
    (() => {
        _73.fourcc = "Opus";
    })(),
    _73);
var mha1SampleEntry = (_74 = class extends AudioSampleEntry {
    },
    __setFunctionName(_74, "mha1SampleEntry"),
    (() => {
        _74.fourcc = "mha1";
    })(),
    _74);
var mha2SampleEntry = (_75 = class extends AudioSampleEntry {
    },
    __setFunctionName(_75, "mha2SampleEntry"),
    (() => {
        _75.fourcc = "mha2";
    })(),
    _75);
var mhm1SampleEntry = (_76 = class extends AudioSampleEntry {
    },
    __setFunctionName(_76, "mhm1SampleEntry"),
    (() => {
        _76.fourcc = "mhm1";
    })(),
    _76);
var mhm2SampleEntry = (_77 = class extends AudioSampleEntry {
    },
    __setFunctionName(_77, "mhm2SampleEntry"),
    (() => {
        _77.fourcc = "mhm2";
    })(),
    _77);
var fLaCSampleEntry = (_78 = class extends AudioSampleEntry {
    },
    __setFunctionName(_78, "fLaCSampleEntry"),
    (() => {
        _78.fourcc = "fLaC";
    })(),
    _78);
var encvSampleEntry = (_79 = class extends VisualSampleEntry {
    },
    __setFunctionName(_79, "encvSampleEntry"),
    (() => {
        _79.fourcc = "encv";
    })(),
    _79);
var encaSampleEntry = (_80 = class extends AudioSampleEntry {
    },
    __setFunctionName(_80, "encaSampleEntry"),
    (() => {
        _80.fourcc = "enca";
    })(),
    _80);
var encuSampleEntry = (_81 = class extends SubtitleSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_81, "encuSampleEntry"),
    (() => {
        _81.fourcc = "encu";
    })(),
    _81);
var encsSampleEntry = (_82 = class extends SystemSampleEntry {
        constructor() {
            super(...arguments);
            this.subBoxNames = ["sinf"];
            this.sinfs = [];
    ...
    __setFunctionName(_82, "encsSampleEntry"),
    (() => {
        _82.fourcc = "encs";
    })(),
    _82);
var mp4sSampleEntry = (_83 = class extends SystemSampleEntry {
    },
    __setFunctionName(_83, "mp4sSampleEntry"),
    (() => {
        _83.fourcc = "mp4s";
    })(),
    _83);
var enctSampleEntry = (_84 = class extends TextSampleEntry {
        constructor() {
            super(...arguments);
            this.subBoxNames = ["sinf"];
            this.sinfs = [];
    ...
    __setFunctionName(_84, "enctSampleEntry"),
    (() => {
        _84.fourcc = "enct";
    })(),
    _84);
var encmSampleEntry = (_85 = class extends MetadataSampleEntry {
        constructor() {
            super(...arguments);
            this.subBoxNames = ["sinf"];
            this.sinfs = [];
    ...
    __setFunctionName(_85, "encmSampleEntry"),
    (() => {
        _85.fourcc = "encm";
    })(),
    _85);
var resvSampleEntry = (_86 = class extends VisualSampleEntry {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_86, "resvSampleEntry"),
    (() => {
        _86.fourcc = "resv";
    })(),
    _86);
// src/boxes/sampleentries/sbtt.ts
var sbttSampleEntry = (_87 = class extends SubtitleSampleEntry {
        parse(stream) {
            this.parseHeader(stream);
            this.content_encoding = stream.readCString();
            this.mime_format = stream.readCString();
    ...
    __setFunctionName(_87, "sbttSampleEntry"),
    (() => {
        _87.fourcc = "sbtt";
    })(),
    _87);
// src/boxes/sampleentries/stpp.ts
var stppSampleEntry = (_88 = class extends SubtitleSampleEntry {
        parse(stream) {
            this.parseHeader(stream);
            this.namespace = stream.readCString();
            this.schema_location = stream.readCString();
    ...
    __setFunctionName(_88, "stppSampleEntry"),
    (() => {
        _88.fourcc = "stpp";
    })(),
    _88);
// src/boxes/sampleentries/stxt.ts
var stxtSampleEntry = (_89 = class extends SubtitleSampleEntry {
        parse(stream) {
            this.parseHeader(stream);
            this.content_encoding = stream.readCString();
            this.mime_format = stream.readCString();
    ...
    __setFunctionName(_89, "stxtSampleEntry"),
    (() => {
        _89.fourcc = "stxt";
    })(),
    _89);
// src/boxes/sampleentries/tx3g.ts
var tx3gSampleEntry = (_90 = class extends SubtitleSampleEntry {
        parse(stream) {
            this.parseHeader(stream);
    ...
    __setFunctionName(_90, "tx3gSampleEntry"),
    (() => {
        _90.fourcc = "tx3g";
    })(),
    _90);
// src/boxes/sampleentries/wvtt.ts
var wvttSampleEntry = (_91 = class extends MetadataSampleEntry {
        parse(stream) {
            this.parseHeader(stream);
            this.parseFooter(stream);
        }
    },
    __setFunctionName(_91, "wvttSampleEntry"),
    (() => {
        _91.fourcc = "wvtt";
    })(),
    _91);
// src/boxes/sbgp.ts
var sbgpBox = (_92 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_92, "sbgpBox"),
    (() => {
        _92.fourcc = "sbgp";
    })(),
    _92);
// src/boxes/sdtp.ts
var sdtpBox = (_93 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_93, "sdtpBox"),
    (() => {
        _93.fourcc = "sdtp";
    })(),
    _93);
// src/boxes/sgpd.ts
var sgpdBox = (_94 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_94, "sgpdBox"),
    (() => {
        _94.fourcc = "sgpd";
    })(),
    _94);
// src/boxes/sidx.ts
var sidxBox = (_95 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_95, "sidxBox"),
    (() => {
        _95.fourcc = "sidx";
    })(),
    _95);
// src/boxes/smhd.ts
var smhdBox = (_96 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_96, "smhdBox"),
    (() => {
        _96.fourcc = "smhd";
    })(),
    _96);
// src/boxes/stco.ts
var stcoBox = (_97 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_97, "stcoBox"),
    (() => {
        _97.fourcc = "stco";
    })(),
    _97);
// src/boxes/sthd.ts
var sthdBox = (_98 = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "SubtitleMediaHeaderBox";
        }
    },
    __setFunctionName(_98, "sthdBox"),
    (() => {
        _98.fourcc = "sthd";
    })(),
    _98);
// src/boxes/stsc.ts
var stscBox = (_99 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_99, "stscBox"),
    (() => {
        _99.fourcc = "stsc";
    })(),
    _99);
// src/boxes/stsd.ts
var stsdBox = (_100 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_100, "stsdBox"),
    (() => {
        _100.fourcc = "stsd";
    })(),
    _100);
// src/boxes/stsz.ts
var stszBox = (_101 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_101, "stszBox"),
    (() => {
        _101.fourcc = "stsz";
    })(),
    _101);
// src/boxes/stts.ts
var sttsBox = (_102 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_102, "sttsBox"),
    (() => {
        _102.fourcc = "stts";
    })(),
    _102);
// src/boxes/tfdt.ts
var tfdtBox = (_103 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_103, "tfdtBox"),
    (() => {
        _103.fourcc = "tfdt";
    })(),
    _103);
// src/boxes/tfhd.ts
var tfhdBox = (_104 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_104, "tfhdBox"),
    (() => {
        _104.fourcc = "tfhd";
    })(),
    _104);
// src/boxes/tkhd.ts
var tkhdBox = (_105 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_105, "tkhdBox"),
    (() => {
        _105.fourcc = "tkhd";
    })(),
    _105);
// src/boxes/trex.ts
var trexBox = (_106 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_106, "trexBox"),
    (() => {
        _106.fourcc = "trex";
    })(),
    _106);
// src/boxes/trun.ts
var trunBox = (_107 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_107, "trunBox"),
    (() => {
        _107.fourcc = "trun";
    })(),
    _107);
// src/boxes/url.ts
var urlBox = (_108 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_108, "urlBox"),
    (() => {
        _108.fourcc = "url ";
    })(),
    _108);
// src/boxes/vmhd.ts
var vmhdBox = (_109 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_109, "vmhdBox"),
    (() => {
        _109.fourcc = "vmhd";
    })(),
    _109);
...
var ISOFile = class _ISOFile {
    ...
    setSegmentOptions(id, user, opts) {
        ...
        if (this.discardMdatData) {
            Log.warn("ISOFile", "Segmentation options set but discardMdatData is true, samples will not be segmented");
        }
    }
    ...
    setExtractionOptions(id, user, { nbSamples: nb_samples = 1e3 } = {}) {
        ...
        if (this.discardMdatData) {
            Log.warn("ISOFile", "Extraction options set but discardMdatData is true, samples will not be extracted");
        }
    }
                ...
                if (ret.code === ERR_NOT_ENOUGH_DATA) {
                    ...
                    if (box.type === "uuid") {
                        if (this[box.uuid] !== void 0) {
                            Log.warn("ISOFile", "Duplicate Box of uuid: " + box.uuid + ", overriding previous occurrence");
                        }
                        this[box.uuid] = box;
                    }
                    else {
            ...
            while (consumedTracks.size < this.fragmentedTracks.length && this.fragmentedTracks.some((track) => track.trak.nextSample < track.trak.samples.length) && this.sampleProcessingStarted) {
                for (const fragTrak of this.fragmentedTracks) {
                    ...
                    if (!consumedTracks.has(fragTrak.id)) {
                        ...
                        if (isFlush && !isRAP) {
                            Log.warn("ISOFile", "Flushing track #" + fragTrak.id + " at sample #" + trak.nextSample + " which is not a RAP, this may lead to playback issues");
                        }
                        ...
                        if (isFragmentBoundary || isSizeBoundary || isFlush) {
                            if (isFragmentOverdue) {
                                Log.warn("ISOFile", "Fragment on track #" + fragTrak.id + " is overdue, creating it with samples [" + fragTrak.state.lastFragmentSampleNumber + ", " + trak.nextSample + "]");
                            }
                            else {
                                Log.debug("ISOFile", "Creating media fragment on track #" + fragTrak.id + " for samples [" + fragTrak.state.lastFragmentSampleNumber + ", " + trak.nextSample + "]");
                            }
                        ...
                        if (isSegmentBoundary || isSizeBoundary || isFlush) {
                            if (isSegmentOverdue) {
                                Log.warn("ISOFile", "Segment on track #" + fragTrak.id + " is overdue, sending it with samples [" + Math.max(0, trak.nextSample - fragTrak.nb_samples) + ", " + (trak.nextSample - 1) + "]");
                            }
                            else {
                            ...
                            Log.info("ISOFile", "Sample data size in memory: " + this.getAllocatedSampleDataSize());
                            if (this.onSegment) {
                                this.onSegment(fragTrak.id, fragTrak.user, fragTrak.segmentStream.buffer, trak.nextSample + 1, last || trak.nextSample + 1 >= trak.samples.length);
                            }
    ...
    getBoxes(type, returnEarly) {
        ...
        const sweep = (root) => {
            ...
            const inner = [];
            if (root["boxes"])
                inner.push(...root.boxes);
            if (root["entries"])
                inner.push(...root["entries"]);
            if (root["item_infos"])
                inner.push(...root["item_infos"]);
            if (root["references"])
                inner.push(...root["references"]);
    ...
    initializeSegmentation() {
        ...
        for (let i = 0; i < this.fragmentedTracks.length; i++) {
            ...
            if (!trak) {
                Log.warn("ISOFile", `Track with id ${this.fragmentedTracks[i].id} not found, skipping fragmentation initialization`);
                continue;
            }
            moov.addBox(trak);
        }
        return {
            ...
            buffer: _ISOFile.writeInitializationSegment(this.ftyp, moov, this.moov?.mvex?.mehd.fragment_duration)
        };
    }
    /**
    ...
    resetTables() {
        ...
        for (let i = 0; i < this.moov.traks.length; i++) {
            ...
            if (k !== -1)
                trak.mdia.minf.stbl.boxes[k] = void 0;
        }
    }
    /** @bundle isofile-sample-processing.js */
                    ...
                    for (let j = 0; j < traf.truns.length; j++) {
                        ...
                        for (let k = 0; k < trun.sample_count; k++) {
                            ...
                            if (traf.sbgps.length > 0 || traf.sgpds.length > 0 || trak.mdia.minf.stbl.sbgps.length > 0 || trak.mdia.minf.stbl.sgpds.length > 0) {
                                _ISOFile.setSampleGroupProperties(trak, sample, sample.number_in_traf, traf.sample_groups_info);
                            }
                        }
                    }
                    if (traf.subs) {
    ...
    flattenItemInfo() {
        ...
        for (let i = 0; i < meta.iinf.item_infos.length; i++) {
            ...
            items[id] = {
                ...
                meta.ipro.protections[meta.iinf.item_infos[i].item_protection_index - 1]) : void 0)
            };
        }
        if (meta.grpl) {
    ...
    addTrack(_options = {}) {
        ...
        if (options.description) {
            sample_description_entry.addBox.call(sample_description_entry, options.description);
        }
    ...
    createMoof(samples) {
        ...
        if (samples.some((s) => s.track_id !== samples[0].track_id)) {
            throw new Error("Cannot create moof for samples from different tracks: " + samples.map((s) => s.track_id).join(", "));
        }
...
// src/boxes/a1lx.ts
var a1lxBox = (_110 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_110, "a1lxBox"),
    (() => {
        _110.fourcc = "a1lx";
    })(),
    _110);
// src/boxes/a1op.ts
var a1opBox = (_111 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_111, "a1opBox"),
    (() => {
        _111.fourcc = "a1op";
    })(),
    _111);
// src/boxes/auxC.ts
var auxCBox = (_112 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_112, "auxCBox"),
    (() => {
        _112.fourcc = "auxC";
    })(),
    _112);
// src/boxes/btrt.ts
var btrtBox = (_113 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_113, "btrtBox"),
    (() => {
        _113.fourcc = "btrt";
    })(),
    _113);
// src/boxes/ccst.ts
var ccstBox = (_114 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_114, "ccstBox"),
    (() => {
        _114.fourcc = "ccst";
    })(),
    _114);
// src/boxes/cdef.ts
var cdefBox = (_115 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_115, "cdefBox"),
    (() => {
        _115.fourcc = "cdef";
    })(),
    _115);
// src/boxes/clap.ts
var clapBox = (_116 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_116, "clapBox"),
    (() => {
        _116.fourcc = "clap";
    })(),
    _116);
// src/boxes/clli.ts
var clliBox = (_117 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_117, "clliBox"),
    (() => {
        _117.fourcc = "clli";
    })(),
    _117);
// src/boxes/cmex.ts
var cmexBox = (_118 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_118, "cmexBox"),
    (() => {
        _118.fourcc = "cmex";
    })(),
    _118);
// src/boxes/cmin.ts
var cminBox = (_119 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_119, "cminBox"),
    (() => {
        _119.fourcc = "cmin";
    })(),
    _119);
// src/boxes/cmpd.ts
var cmpdBox = (_120 = class extends Box {
        constructor() {
            super(...arguments);
            this.box_name = "ComponentDefinitionBox";
        }
    ...
    __setFunctionName(_120, "cmpdBox"),
    (() => {
        _120.fourcc = "cmpd";
    })(),
    _120);
// src/boxes/co64.ts
var co64Box = (_121 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_121, "co64Box"),
    (() => {
        _121.fourcc = "co64";
    })(),
    _121);
// src/boxes/CoLL.ts
var CoLLBox = (_122 = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "ContentLightLevelBox";
        }
    ...
    __setFunctionName(_122, "CoLLBox"),
    (() => {
        _122.fourcc = "CoLL";
    })(),
    _122);
...
var coviBox = (_123 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_123, "coviBox"),
    (() => {
        _123.fourcc = "covi";
    })(),
    _123);
// src/boxes/cprt.ts
var cprtBox = (_124 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_124, "cprtBox"),
    (() => {
        _124.fourcc = "cprt";
    })(),
    _124);
// src/boxes/csch.ts
var cschBox = (_125 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_125, "cschBox"),
    (() => {
        _125.fourcc = "csch";
    })(),
    _125);
...
var cslgBox = (_126 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_126, "cslgBox"),
    (() => {
        _126.fourcc = "cslg";
    })(),
    _126);
// src/boxes/ctts.ts
var cttsBox = (_127 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_127, "cttsBox"),
    (() => {
        _127.fourcc = "ctts";
    })(),
    _127);
// src/boxes/dac3.ts
var dac3Box = (_128 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_128, "dac3Box"),
    (() => {
        _128.fourcc = "dac3";
    })(),
    _128);
// src/boxes/dec3.ts
var dec3Box = (_129 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_129, "dec3Box"),
    (() => {
        _129.fourcc = "dec3";
    })(),
    _129);
// src/boxes/dfLa.ts
var dfLaBox = (_130 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_130, "dfLaBox"),
    (() => {
        _130.fourcc = "dfLa";
    })(),
    _130);
// src/boxes/dimm.ts
var dimmBox = (_131 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_131, "dimmBox"),
    (() => {
        _131.fourcc = "dimm";
    })(),
    _131);
// src/boxes/dmax.ts
var dmax = (_132 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_132, "dmax"),
    (() => {
        _132.fourcc = "dmax";
    })(),
    _132);
// src/boxes/dmed.ts
var dmedBox = (_133 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_133, "dmedBox"),
    (() => {
        _133.fourcc = "dmed";
    })(),
    _133);
// src/boxes/dOps.ts
var dOpsBox = (_134 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_134, "dOpsBox"),
    (() => {
        _134.fourcc = "dOps";
    })(),
    _134);
// src/boxes/drep.ts
var drepBox = (_135 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_135, "drepBox"),
    (() => {
        _135.fourcc = "drep";
    })(),
    _135);
// src/boxes/elst.ts
var elstBox = (_136 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_136, "elstBox"),
    (() => {
        _136.fourcc = "elst";
    })(),
    _136);
// src/boxes/emsg.ts
var emsgBox = (_137 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_137, "emsgBox"),
    (() => {
        _137.fourcc = "emsg";
    })(),
    _137);
...
var aebrBox = (_138 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Auto exposure bracketing";
        }
    },
    __setFunctionName(_138, "aebrBox"),
    (() => {
        _138.fourcc = "aebr";
    })(),
    _138);
var afbrBox = (_139 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Flash exposure information";
        }
    },
    __setFunctionName(_139, "afbrBox"),
    (() => {
        _139.fourcc = "afbr";
    })(),
    _139);
var albcBox = (_140 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Album collection";
        }
    },
    __setFunctionName(_140, "albcBox"),
    (() => {
        _140.fourcc = "albc";
    })(),
    _140);
var altrBox = (_141 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Alternative entity";
        }
    },
    __setFunctionName(_141, "altrBox"),
    (() => {
        _141.fourcc = "altr";
    })(),
    _141);
var brstBox = (_142 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Burst image";
        }
    },
    __setFunctionName(_142, "brstBox"),
    (() => {
        _142.fourcc = "brst";
    })(),
    _142);
var dobrBox = (_143 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Depth of field bracketing";
        }
    },
    __setFunctionName(_143, "dobrBox"),
    (() => {
        _143.fourcc = "dobr";
    })(),
    _143);
var eqivBox = (_144 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Equivalent entity";
        }
    },
    __setFunctionName(_144, "eqivBox"),
    (() => {
        _144.fourcc = "eqiv";
    })(),
    _144);
var favcBox = (_145 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Favorites collection";
        }
    },
    __setFunctionName(_145, "favcBox"),
    (() => {
        _145.fourcc = "favc";
    })(),
    _145);
var fobrBox = (_146 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Focus bracketing";
        }
    },
    __setFunctionName(_146, "fobrBox"),
    (() => {
        _146.fourcc = "fobr";
    })(),
    _146);
var iaugBox = (_147 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Image item with an audio track";
        }
    },
    __setFunctionName(_147, "iaugBox"),
    (() => {
        _147.fourcc = "iaug";
    })(),
    _147);
var panoBox = (_148 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Panorama";
        }
    },
    __setFunctionName(_148, "panoBox"),
    (() => {
        _148.fourcc = "pano";
    })(),
    _148);
var slidBox = (_149 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Slideshow";
        }
    },
    __setFunctionName(_149, "slidBox"),
    (() => {
        _149.fourcc = "slid";
    })(),
    _149);
var sterBox = (_150 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Stereo";
        }
    },
    __setFunctionName(_150, "sterBox"),
    (() => {
        _150.fourcc = "ster";
    })(),
    _150);
var tsynBox = (_151 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Time-synchronized capture";
        }
    },
    __setFunctionName(_151, "tsynBox"),
    (() => {
        _151.fourcc = "tsyn";
    })(),
    _151);
var wbbrBox = (_152 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "White balance bracketing";
        }
    },
    __setFunctionName(_152, "wbbrBox"),
    (() => {
        _152.fourcc = "wbbr";
    })(),
    _152);
var prgrBox = (_153 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
            this.box_name = "Progressive rendering";
        }
    },
    __setFunctionName(_153, "prgrBox"),
    (() => {
        _153.fourcc = "prgr";
    })(),
    _153);
var pymdBox = (_154 = class extends EntityToGroup {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_154, "pymdBox"),
    (() => {
        _154.fourcc = "pymd";
    })(),
    _154);
// src/boxes/fiel.ts
var fielBox = (_155 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_155, "fielBox"),
    (() => {
        _155.fourcc = "fiel";
    })(),
    _155);
// src/boxes/frma.ts
var frmaBox = (_156 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_156, "frmaBox"),
    (() => {
        _156.fourcc = "frma";
    })(),
    _156);
// src/boxes/imir.ts
var imirBox = (_157 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_157, "imirBox"),
    (() => {
        _157.fourcc = "imir";
    })(),
    _157);
// src/boxes/ipma.ts
var ipmaBox = (_158 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_158, "ipmaBox"),
    (() => {
        _158.fourcc = "ipma";
    })(),
    _158);
// src/boxes/irot.ts
var irotBox = (_159 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_159, "irotBox"),
    (() => {
        _159.fourcc = "irot";
    })(),
    _159);
// src/boxes/ispe.ts
var ispeBox = (_160 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_160, "ispeBox"),
    (() => {
        _160.fourcc = "ispe";
    })(),
    _160);
// src/boxes/itai.ts
var itaiBox = (_161 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_161, "itaiBox"),
    (() => {
        _161.fourcc = "itai";
    })(),
    _161);
// src/boxes/kind.ts
var kindBox = (_162 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_162, "kindBox"),
    (() => {
        _162.fourcc = "kind";
    })(),
    _162);
// src/boxes/leva.ts
var levaBox = (_163 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_163, "levaBox"),
    (() => {
        _163.fourcc = "leva";
    })(),
    _163);
// src/boxes/lhvC.ts
var lhvCBox = (_164 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_164, "lhvCBox"),
    (() => {
        _164.fourcc = "lhvC";
    })(),
    _164);
// src/boxes/lsel.ts
var lselBox = (_165 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_165, "lselBox"),
    (() => {
        _165.fourcc = "lsel";
    })(),
    _165);
// src/boxes/maxr.ts
var maxrBox = (_166 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_166, "maxrBox"),
    (() => {
        _166.fourcc = "maxr";
    })(),
    _166);
...
// src/boxes/mdcv.ts
var mdcvBox = (_167 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_167, "mdcvBox"),
    (() => {
        _167.fourcc = "mdcv";
    })(),
    _167);
// src/boxes/mfro.ts
var mfroBox = (_168 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_168, "mfroBox"),
    (() => {
        _168.fourcc = "mfro";
    })(),
    _168);
// src/boxes/mskC.ts
var mskCBox = (_169 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_169, "mskCBox"),
    (() => {
        _169.fourcc = "mskC";
    })(),
    _169);
// src/boxes/npck.ts
var npckBox = (_170 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_170, "npckBox"),
    (() => {
        _170.fourcc = "npck";
    })(),
    _170);
// src/boxes/nump.ts
var numpBox = (_171 = class extends Box {
        constructor() {
            super(...arguments);
            this.box_name = "hintPacketsSent";
        }
    ...
    __setFunctionName(_171, "numpBox"),
    (() => {
        _171.fourcc = "nump";
    })(),
    _171);
...
var padbBox = (_172 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_172, "padbBox"),
    (() => {
        _172.fourcc = "padb";
    })(),
    _172);
// src/boxes/pasp.ts
var paspBox = (_173 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_173, "paspBox"),
    (() => {
        _173.fourcc = "pasp";
    })(),
    _173);
// src/boxes/payl.ts
var paylBox = (_174 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_174, "paylBox"),
    (() => {
        _174.fourcc = "payl";
    })(),
    _174);
// src/boxes/payt.ts
var paytBox = (_175 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_175, "paytBox"),
    (() => {
        _175.fourcc = "payt";
    })(),
    _175);
// src/boxes/pdin.ts
var pdinBox = (_176 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_176, "pdinBox"),
    (() => {
        _176.fourcc = "pdin";
    })(),
    _176);
// src/boxes/pixi.ts
var pixiBox = (_177 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_177, "pixiBox"),
    (() => {
        _177.fourcc = "pixi";
    })(),
    _177);
// src/boxes/pmax.ts
var pmaxBox = (_178 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_178, "pmaxBox"),
    (() => {
        _178.fourcc = "pmax";
    })(),
    _178);
// src/boxes/prdi.ts
var prdiBox = (_179 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_179, "prdiBox"),
    (() => {
        _179.fourcc = "prdi";
    })(),
    _179);
// src/boxes/prfr.ts
var prfrBox = (_180 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_180, "prfrBox"),
    (() => {
        _180.fourcc = "prfr";
    })(),
    _180);
// src/boxes/prft.ts
var prftBox = (_181 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_181, "prftBox"),
    (() => {
        _181.fourcc = "prft";
    })(),
    _181);
// src/boxes/pssh.ts
var psshBox = (_182 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_182, "psshBox"),
    (() => {
        _182.fourcc = "pssh";
    })(),
    _182);
// src/boxes/qt/clef.ts
var clefBox = (_183 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_183, "clefBox"),
    (() => {
        _183.fourcc = "clef";
    })(),
    _183);
...
var dataBox = (_184 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_184, "dataBox"),
    (() => {
        _184.fourcc = "data";
    })(),
    (() => {
...
var enofBox = (_185 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_185, "enofBox"),
    (() => {
        _185.fourcc = "enof";
    })(),
    _185);
// src/boxes/qt/ilst.ts
var ilstBox = (_186 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_186, "ilstBox"),
    (() => {
        _186.fourcc = "ilst";
    })(),
    _186);
// src/boxes/qt/keys.ts
var keysBox = (_187 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_187, "keysBox"),
    (() => {
        _187.fourcc = "keys";
    })(),
    _187);
// src/boxes/qt/prof.ts
var profBox = (_188 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_188, "profBox"),
    (() => {
        _188.fourcc = "prof";
    })(),
    _188);
// src/boxes/qt/tapt.ts
var taptBox = (_189 = class extends ContainerBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_189, "taptBox"),
    (() => {
        _189.fourcc = "tapt";
    })(),
    _189);
// src/boxes/qt/wave.ts
var waveBox = (_190 = class extends ContainerBox {
        constructor() {
            super(...arguments);
            this.box_name = "siDecompressionParamBox";
        }
    },
    __setFunctionName(_190, "waveBox"),
    (() => {
        _190.fourcc = "wave";
    })(),
    _190);
// src/boxes/rtp.ts
var rtp_Box = (_191 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_191, "rtp_Box"),
    (() => {
        _191.fourcc = "rtp ";
    })(),
    _191);
// src/boxes/saio.ts
var saioBox = (_192 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_192, "saioBox"),
    (() => {
        _192.fourcc = "saio";
    })(),
    _192);
// src/boxes/saiz.ts
var saizBox = (_193 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_193, "saizBox"),
    (() => {
        _193.fourcc = "saiz";
    })(),
    _193);
...
// src/boxes/sbpm.ts
var sbpmBox = (_194 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_194, "sbpmBox"),
    (() => {
        _194.fourcc = "sbpm";
    })(),
    _194);
// src/boxes/schm.ts
var schmBox = (_195 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_195, "schmBox"),
    (() => {
        _195.fourcc = "schm";
    })(),
    _195);
// src/boxes/sdp.ts
var sdp_Box = (_196 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_196, "sdp_Box"),
    (() => {
        _196.fourcc = "sdp ";
    })(),
    _196);
// src/boxes/senc.ts
var sencBox = (_197 = class extends FullBox {
        constructor() {
            super(...arguments);
            this.box_name = "SampleEncryptionBox";
        }
    },
    __setFunctionName(_197, "sencBox"),
    (() => {
        _197.fourcc = "senc";
    })(),
    _197);
// src/boxes/SmDm.ts
var SmDmBox = (_198 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_198, "SmDmBox"),
    (() => {
        _198.fourcc = "SmDm";
    })(),
    _198);
// src/boxes/srat.ts
var sratBox = (_199 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_199, "sratBox"),
    (() => {
        _199.fourcc = "srat";
    })(),
    _199);
// src/boxes/ssix.ts
var ssixBox = (_200 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_200, "ssixBox"),
    (() => {
        _200.fourcc = "ssix";
    })(),
    _200);
// src/boxes/stdp.ts
var stdpBox = (_201 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_201, "stdpBox"),
    (() => {
        _201.fourcc = "stpd";
    })(),
    _201);
// src/boxes/stri.ts
var striBox = (_202 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_202, "striBox"),
    (() => {
        _202.fourcc = "stri";
    })(),
    _202);
// src/boxes/stsg.ts
var stsgBox = (_203 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_203, "stsgBox"),
    (() => {
        _203.fourcc = "stsg";
    })(),
    _203);
// src/boxes/stsh.ts
var stshBox = (_204 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_204, "stshBox"),
    (() => {
        _204.fourcc = "stsh";
    })(),
    _204);
// src/boxes/stss.ts
var stssBox = (_205 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_205, "stssBox"),
    (() => {
        _205.fourcc = "stss";
    })(),
    _205);
// src/boxes/stvi.ts
var stviBox = (_206 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_206, "stviBox"),
    (() => {
        _206.fourcc = "stvi";
    })(),
    _206);
// src/boxes/styp.ts
var stypBox = (_207 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_207, "stypBox"),
    (() => {
        _207.fourcc = "styp";
    })(),
    _207);
// src/boxes/stz2.ts
var stz2Box = (_208 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_208, "stz2Box"),
    (() => {
        _208.fourcc = "stz2";
    })(),
    _208);
// src/boxes/subs.ts
var subsBox = (_209 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_209, "subsBox"),
    (() => {
        _209.fourcc = "subs";
    })(),
    _209);
// src/boxes/taic.ts
var taicBox = (_210 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_210, "taicBox"),
    (() => {
        _210.fourcc = "taic";
    })(),
    _210);
// src/boxes/tenc.ts
var tencBox = (_211 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_211, "tencBox"),
    (() => {
        _211.fourcc = "tenc";
    })(),
    _211);
// src/boxes/tfra.ts
var tfraBox = (_212 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_212, "tfraBox"),
    (() => {
        _212.fourcc = "tfra";
    })(),
    _212);
// src/boxes/tmax.ts
var tmaxBox = (_213 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_213, "tmaxBox"),
    (() => {
        _213.fourcc = "tmax";
    })(),
    _213);
// src/boxes/tmin.ts
var tminBox = (_214 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_214, "tminBox"),
    (() => {
        _214.fourcc = "tmin";
    })(),
    _214);
// src/boxes/totl.ts
var totlBox = (_215 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_215, "totlBox"),
    (() => {
        _215.fourcc = "totl";
    })(),
    _215);
// src/boxes/tpay.ts
var tpayBox = (_216 = class extends Box {
        constructor() {
            super(...arguments);
            this.box_name = "hintBytesSent";
        }
    ...
    __setFunctionName(_216, "tpayBox"),
    (() => {
        _216.fourcc = "tpay";
    })(),
    _216);
// src/boxes/tpyl.ts
var tpylBox = (_217 = class extends Box {
        constructor() {
            super(...arguments);
            this.box_name = "hintBytesSent";
        }
    ...
    __setFunctionName(_217, "tpylBox"),
    (() => {
        _217.fourcc = "tpyl";
    })(),
    _217);
// src/boxes/trackgroups/msrc.ts
var msrcTrackGroupTypeBox = (_218 = class extends TrackGroupTypeBox {
    },
    __setFunctionName(_218, "msrcTrackGroupTypeBox"),
    (() => {
        _218.fourcc = "msrc";
    })(),
    _218);
// src/boxes/tref.ts
var trefBox = (_219 = class _trefBox extends Box {
        constructor() {
            super(...arguments);
        ...
        parse(stream) {
            while (stream.getPosition() < this.start + this.size) {
                const ret = parseOneBox(stream, true, this.size - (stream.getPosition() - this.start));
                if (ret.code === OK) {
                    if (!_219.allowed_types.includes(ret.type)) {
    ...
    _219);
// src/boxes/trep.ts
var trepBox = (_220 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_220, "trepBox"),
    (() => {
        _220.fourcc = "trep";
    })(),
    _220);
// src/boxes/trpy.ts
var trpyBox = (_221 = class extends Box {
        constructor() {
            super(...arguments);
            this.box_name = "hintBytesSent";
        }
    ...
    __setFunctionName(_221, "trpyBox"),
    (() => {
        _221.fourcc = "trpy";
    })(),
    _221);
// src/boxes/tsel.ts
var tselBox = (_222 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_222, "tselBox"),
    (() => {
        _222.fourcc = "tsel";
    })(),
    _222);
// src/boxes/txtC.ts
var txtcBox = (_223 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_223, "txtcBox"),
    (() => {
        _223.fourcc = "txtc";
    })(),
    _223);
// src/boxes/tyco.ts
var tycoBox = (_224 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_224, "tycoBox"),
    (() => {
        _224.fourcc = "tyco";
    })(),
    _224);
// src/boxes/udes.ts
var udesBox = (_225 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_225, "udesBox"),
    (() => {
        _225.fourcc = "udes";
    })(),
    _225);
// src/boxes/uncC.ts
var uncCBox = (_226 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_226, "uncCBox"),
    (() => {
        _226.fourcc = "uncC";
    })(),
    _226);
// src/boxes/urn.ts
var urnBox = (_227 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_227, "urnBox"),
    (() => {
        _227.fourcc = "urn ";
    })(),
    _227);
// src/boxes/vttC.ts
var vttCBox = (_228 = class extends Box {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_228, "vttCBox"),
    (() => {
        _228.fourcc = "vttC";
    })(),
    _228);
// src/boxes/vvnC.ts
var vvnCBox = (_229 = class extends FullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_229, "vvnCBox"),
    (() => {
        _229.fourcc = "vvnC";
    })(),
    _229);
// src/boxes/samplegroups/alst.ts
var alstSampleGroupEntry = (_230 = class extends SampleGroupEntry {
        parse(stream) {
    ...
    __setFunctionName(_230, "alstSampleGroupEntry"),
    (() => {
        _230.grouping_type = "alst";
    })(),
    _230);
// src/boxes/samplegroups/avll.ts
var avllSampleGroupEntry = (_231 = class extends SampleGroupEntry {
        parse(stream) {
    ...
    __setFunctionName(_231, "avllSampleGroupEntry"),
    (() => {
        _231.grouping_type = "avll";
    })(),
    _231);
// src/boxes/samplegroups/avss.ts
var avssSampleGroupEntry = (_232 = class extends SampleGroupEntry {
        parse(stream) {
    ...
    __setFunctionName(_232, "avssSampleGroupEntry"),
    (() => {
        _232.grouping_type = "avss";
    })(),
    _232);
// src/boxes/samplegroups/dtrt.ts
var dtrtSampleGroupEntry = (_233 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_233, "dtrtSampleGroupEntry"),
    (() => {
        _233.grouping_type = "dtrt";
    })(),
    _233);
// src/boxes/samplegroups/mvif.ts
var mvifSampleGroupEntry = (_234 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_234, "mvifSampleGroupEntry"),
    (() => {
        _234.grouping_type = "mvif";
    })(),
    _234);
// src/boxes/samplegroups/prol.ts
var prolSampleGroupEntry = (_235 = class extends SampleGroupEntry {
        parse(stream) {
            this.roll_distance = stream.readInt16();
        }
    },
    __setFunctionName(_235, "prolSampleGroupEntry"),
    (() => {
        _235.grouping_type = "prol";
    })(),
    _235);
// src/boxes/samplegroups/rap.ts
var rapSampleGroupEntry = (_236 = class extends SampleGroupEntry {
        parse(stream) {
            const tmp_byte = stream.readUint8();
    ...
    __setFunctionName(_236, "rapSampleGroupEntry"),
    (() => {
        _236.grouping_type = "rap ";
    })(),
    _236);
// src/boxes/samplegroups/rash.ts
var rashSampleGroupEntry = (_237 = class extends SampleGroupEntry {
        parse(stream) {
    ...
    __setFunctionName(_237, "rashSampleGroupEntry"),
    (() => {
        _237.grouping_type = "rash";
    })(),
    _237);
// src/boxes/samplegroups/roll.ts
var rollSampleGroupEntry = (_238 = class extends SampleGroupEntry {
        parse(stream) {
            this.roll_distance = stream.readInt16();
        }
    },
    __setFunctionName(_238, "rollSampleGroupEntry"),
    (() => {
        _238.grouping_type = "roll";
    })(),
    _238);
// src/boxes/samplegroups/scif.ts
var scifSampleGroupEntry = (_239 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_239, "scifSampleGroupEntry"),
    (() => {
        _239.grouping_type = "scif";
    })(),
    _239);
// src/boxes/samplegroups/scnm.ts
var scnmSampleGroupEntry = (_240 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_240, "scnmSampleGroupEntry"),
    (() => {
        _240.grouping_type = "scnm";
    })(),
    _240);
// src/boxes/samplegroups/seig.ts
var seigSampleGroupEntry = (_241 = class extends SampleGroupEntry {
        parse(stream) {
    ...
    __setFunctionName(_241, "seigSampleGroupEntry"),
    (() => {
        _241.grouping_type = "seig";
    })(),
    _241);
// src/boxes/samplegroups/stsa.ts
var stsaSampleGroupEntry = (_242 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_242, "stsaSampleGroupEntry"),
    (() => {
        _242.grouping_type = "stsa";
    })(),
    _242);
// src/boxes/samplegroups/sync.ts
var syncSampleGroupEntry = (_243 = class extends SampleGroupEntry {
        parse(stream) {
            const tmp_byte = stream.readUint8();
            this.NAL_unit_type = tmp_byte & 63;
        }
    },
    __setFunctionName(_243, "syncSampleGroupEntry"),
    (() => {
        _243.grouping_type = "sync";
    })(),
    _243);
// src/boxes/samplegroups/tele.ts
var teleSampleGroupEntry = (_244 = class extends SampleGroupEntry {
        parse(stream) {
            const tmp_byte = stream.readUint8();
            this.level_independently_decodable = tmp_byte >> 7;
        }
    },
    __setFunctionName(_244, "teleSampleGroupEntry"),
    (() => {
        _244.grouping_type = "tele";
    })(),
    _244);
// src/boxes/samplegroups/tsas.ts
var tsasSampleGroupEntry = (_245 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_245, "tsasSampleGroupEntry"),
    (() => {
        _245.grouping_type = "tsas";
    })(),
    _245);
// src/boxes/samplegroups/tscl.ts
var tsclSampleGroupEntry = (_246 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_246, "tsclSampleGroupEntry"),
    (() => {
        _246.grouping_type = "tscl";
    })(),
    _246);
// src/boxes/samplegroups/vipr.ts
var viprSampleGroupEntry = (_247 = class extends SampleGroupEntry {
        parse(_stream) {
            Log.warn("BoxParser", "Sample Group type: " + this.grouping_type + " not fully parsed");
        }
    },
    __setFunctionName(_247, "viprSampleGroupEntry"),
    (() => {
        _247.grouping_type = "vipr";
    })(),
    _247);
// src/boxes/uuid/index.ts
var UUIDBox = (_248 = class extends Box {
    },
    __setFunctionName(_248, "UUIDBox"),
    (() => {
        _248.fourcc = "uuid";
    })(),
    _248);
var UUIDFullBox = (_249 = class extends FullBox {
    },
    __setFunctionName(_249, "UUIDFullBox"),
    (() => {
        _249.fourcc = "uuid";
    })(),
    _249);
var piffLsmBox = (_250 = class extends UUIDFullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_250, "piffLsmBox"),
    (() => {
        _250.uuid = "a5d40b30e81411ddba2f0800200c9a66";
    })(),
    _250);
var piffPsshBox = (_251 = class extends UUIDFullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_251, "piffPsshBox"),
    (() => {
        _251.uuid = "d08a4f1810f34a82b6c832d8aba183d3";
    })(),
    _251);
var piffSencBox = (_252 = class extends UUIDFullBox {
        constructor() {
            super(...arguments);
            this.box_name = "PiffSampleEncryptionBox";
        }
    },
    __setFunctionName(_252, "piffSencBox"),
    (() => {
        _252.uuid = "a2394f525a9b4f14a2446c427c648df4";
    })(),
    _252);
var piffTencBox = (_253 = class extends UUIDFullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_253, "piffTencBox"),
    (() => {
        _253.uuid = "8974dbce7be74c5184f97148f9882554";
    })(),
    _253);
var piffTfrfBox = (_254 = class extends UUIDFullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_254, "piffTfrfBox"),
    (() => {
        _254.uuid = "d4807ef2ca3946958e5426cb9e46a79f";
    })(),
    _254);
var piffTfxdBox = (_255 = class extends UUIDFullBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_255, "piffTfxdBox"),
    (() => {
        _255.uuid = "6d1d9b0542d544e680e2141daff757b2";
    })(),
    _255);
var ItemContentIDPropertyBox = (_256 = class extends UUIDBox {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_256, "ItemContentIDPropertyBox"),
    (() => {
        _256.uuid = "261ef3741d975bbaacbd9d2c8ea73522";
    })(),
    _256);
// entries/all.ts
